...
loc_exp = ROOTDIR+'SIMULAZIONI_ORCHIDEE_SITI/SITES_dataset_Century.xlsx'
...
#with foggia
site_T0_array_all=npy.array(['CHNO3_Min', 'COL_T0', 'CREC3_Min', 'FEU_T0', 'JEU2_M0', 'LAJA2_Min', 'LAJA3_Min', 'RHEU1_Min', 'RHEU2_T0','ARAZ_D0_N0', 'ULT_P0_B', 'BROAD_3_Nill', 'DwN0', 'TREV1_Min','AVRI_T1TR'])
...
#################
n=0 # contatore
inp=open('opt_q10Tref_forscript2.11.txt','rb')
while inp.read(1):
    inp.seek(-1,1)
