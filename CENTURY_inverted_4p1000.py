...
OUTPUT_files=ROOTDIR+'SCRIPT_MODELLI/MULTIMODEL/OUTPUTS_4p1000_v5/CENTURY/'
...
site_T0_array_all=npy.array(['CHNO3_Min', 'COL_T0', 'CREC3_Min', 'FEU_T0', 'JEU2_M0', 'LAJA2_Min', 'RHEU1_Min', 'RHEU2_T0','ARAZ_D0_N0', 'ULT_P0_B', 'BROAD_3_Nill', 'TREV1_Min','AVRI_T1TR','BOLO_T0', 'GRAB_CP','MUNCHE_CP','RITZ_CP'])
...
#################
n=0 # contatore
inp=open(ROOTDIR+'SCRIPT_MODELLI/MULTIMODEL/OPTIM_MODELS/OPTIM5/optim1_param_CENTURY.txt','rb')
while inp.read(1):
    inp.seek(-1,1)
...
#################
n=0 # contatore
inp=open(ROOTDIR+'SCRIPT_MODELLI/MULTIMODEL/OPTIM_MODELS/OPTIM5/optim2_param_CENTURY.txt','rb')
...
# forward
########################################################################
#def forward(YEARS,init,litter_inc,tau_array,clay,temp_t,water_t, soilQ10_t):
...
#    matrix_in=npy.append(litter_inc,[0.,0.,0.])*dt      # input term I
...
for j in range(N_sites):
	...
	SOC_pools_out=npy.stack((SOC_model_standard_pools/100.,SOC_model_opt_pools/100.))
	SOC_out=npy.stack((year_out,SOC_model_standard/100.,SOC_model_opt/100.)) #tC/ha
