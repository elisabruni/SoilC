...
site_T0_array=npy.array(['CHNO3_Min', 'COL_T0', 'CREC3_Min', 'FEU_T0', 'JEU2_M0', 'LAJA2_Min', 'RHEU1_Min', 'RHEU2_T0','ARAZ_D0_N0', 'ULT_P0_B', 'BROAD_3_Nill', 'TREV1_Min','AVRI_T1TR', 'BOLO_T0', 'GRAB_CP', 'MUNCHE_CP','RITZ_CP'])
...
for j in range(N_sites):
	...
	ssp_o = npy.array([ssp])
        SOC_model = npy.concatenate((ssp_o,param_predict_c_forward))
	SOC_error=SOC_var
